<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mesajlar.aspx.cs" Inherits="softv1.panel.dist.mesajlar" %>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="mesajlar.aspx"><i class="sidebar-item-icon fa fa-edit"></i>
                    ...
                    <div class="page-content fade-in-up">
                        <div class="ibox">
                            <div class="ibox-head">
                                ...
                                <br>
                                    <small>
                                        <asp:Label ID="lblMesajSayi" runat="server" Text="0"></asp:Label>
                                        sonuç bulundu.</small>
                                </div>

                            </div>
                            <div class="ibox-body">
                                <asp:DataList ID="DataMesajlar" runat="server" class="table table-striped table-bordered table-hover" OnItemCommand="DataMesajlar_ItemCommand1">
                                    <HeaderTemplate>
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblMesajID" runat="server" Text='<%# Eval("mesaj_ID") %>'></asp:Label></td>

                                            <td><%# Eval("mesaj_gonderen") %></td>
                                            <td><%# Eval("mesaj_mail") %></td>
                                            <td>
                                                <%# Eval("mesaj_baslik") %>
                                            </td>
                                            <td><%# Eval("mesaj_tarih") %>
                                            </td>
                                            <td><%# Eval("mesaj_durum") %></td>
                                            <td>
                                                <a href="Edit.aspx?mid=<%#Eval("mesaj_ID") %>" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="İncele"><i class="fa fa-eye font-14"></i></a>
                                                <asp:Button ID="btnDelete" runat="server" Text="SİL" class="btn btn-default btn-xs m-r-5" CommandName="DELETE" /></td>
                                        </tr>
                                    </ItemTemplate>
