<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urunolustur.aspx.cs" Inherits="softv1.panel.urunolustur" %>
                ...
                <div class="row">
                    <div class="col">
                        <div class="ibox ibox-primary">
                            <div class="ibox-head">
                                <div class="ibox-title">Yeni Ürün Bilgileri</div>
                            </div>
                            <div class="ibox-body">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                         ...
                                         <asp:TextBox ID="txtTur" runat="server"  CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Ürün Resmi</label>
                                            <asp:Label ID="Label1" runat="server" Text="Resim Eklemeyi Unutmayınız"></asp:Label>
                                            <asp:FileUpload ID="fileResim" runat="server" CssClass="form-control"/>
                                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnUpload_Click" CssClass="btn btn-danger">YÜKLE</asp:LinkButton>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Kategori (Ürünler listesinde hangi sekmede gözüksün Örn:1-2-3)</label>
                                         <asp:TextBox ID="txtKategori" runat="server"  CssClass="form-control" TextMode="Number"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
