<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="duyurular.aspx.cs" Inherits="softv1.panel.WebForm1" %>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">
                            <asp:Label ID="lblUsername2" runat="server" Text="Admin"></asp:Label>
                        </div>
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="duyurular.aspx"><i class="sidebar-item-icon fa fa-bullhorn"></i>
                        ...
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">
                                    ...
                                    <br>
                                    <small>
                                        <asp:Label ID="lblSayi" runat="server" Text="0"></asp:Label>
                                        sonuç bulundu.</small>
                                </div>
                            </div>
                            <div class="ibox ibox-primary">
                                <div class="ibox-head">
                                    <div class="ibox-title">Yeni Duyuru Yap</div>
                                </div>
                                <div class="ibox-body">

                                    <div class="form-group">
                                        <label>Duyuru Metni</label>
                                        <asp:TextBox ID="txtDuyuru" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>

                                    <div class="form-group">
                                        <asp:Button ID="btnKaydet" runat="server" Text="DUYURU OLUŞTUR" CssClass="btn btn-success btn-block" onClick="btnDuyuruEkle_Click"/>
                                    </div>
                            ...
                            <div class="ibox-body">
                                    ...
                                    <asp:DataList ID="DataDuyuru" runat="server" class="table table-striped table-bordered table-hover" CellSpacing="0" OnItemCommand="DataDuyuru_ItemCommand">
                                        <HeaderTemplate>
                                            <tr>
                                                <th>ID</th>
                                                <th>Yetkili</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblDuyuruID" runat="server" Text='<%# Eval("duyuru_ID") %>'></asp:Label></td>
                                                <td style="min-width: 100px"><%# Eval("duyuru_yetkili") %></td>
                                                <td><%# Eval("duyuru_metni") %></td>
                                                <td>
                                                    <%# Eval("duyuru_tarih") %>
                                                </td>
                                                <td><span class="badge badge-primary m-r-5 m-b-5"><%# Eval("gosterim") %></span></td>
                                                <td>
                                                    <asp:Button ID="btnDelete" runat="server" Text="SİL" class="btn btn-default btn-xs m-r-5" CommandName="DELETE" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:DataList>
