<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bayilistesi.aspx.cs" Inherits="softv1.panel.dist.bayilistesi" %>
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a class="active" href="bayilistesi.aspx">Bayi Listesi</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="page-content fade-in-up">
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <asp:DataList ID="DataBayiler" runat="server" CssClass="table table-striped table-bordered table-hover" OnItemCommand="DataBayiler_ItemCommand">
                                <HeaderTemplate>
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblBayiID" runat="server" Text='<%# Eval("bayi_ID") %>'></asp:Label>
                                        </td>
                                        <td style="min-width: 100px"><%# Eval("bayi_ad") %></td>
                                        <td><%# Eval("bayi_sehir") %></td>
                                        <td>
                                            <%# Eval("bayi_telefon") %>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <%# Eval("bayi_faturaadres") %>
                                        </td>
                                        <td>
                                            <a href="Edit.aspx?bid=<%#Eval("bayi_id") %>" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Düzenle"><i class="fa fa-pencil font-14"></i></a>
