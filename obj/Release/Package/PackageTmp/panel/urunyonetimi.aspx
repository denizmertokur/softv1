<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urunyonetimi.aspx.cs" Inherits="softv1.panel.urun" %>
                ...
                <ul class="nav navbar-toolbar">
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <span></span>
                            <asp:Label ID="lblUsername" runat="server" Text="Label"></asp:Label><i class="fa fa-angle-down m-l-5"></i></a>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">
                            <asp:Label ID="lblUsername2" runat="server" Text="Label"></asp:Label></div><small>Administrator</small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a  class="active" href="urunyonetimi.aspx"><i class="sidebar-item-icon fa fa-table"></i>
...
<div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Ürünler <br>
                            <small>
                                <asp:Label ID="lblSayi" runat="server" Text="0"></asp:Label> sonuç bulundu.</small><asp:Button ID="btnUrunEkle" runat="server" Text="ÜRÜN EKLE" CssClass="btn btn-block btn-success" OnClick="btnUrunEkle_Click"/></div>
                    </div>

                    <div class="ibox-body">
                            <asp:DataList ID="DataUrun" runat="server" class="table table-striped table-bordered table-hover" CellSpacing="0" OnItemCommand="DataUrun_ItemCommand">
                            <HeaderTemplate>
                                <tr>
                                    <th>ID</th>
                                    <th>İsim</th>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblUrunID" runat="server" Text='<%# Eval("urun_ID") %>'></asp:Label>
                                        </td>
                                    <td style="min-width:100px"><%# Eval("Urun_adi") %></td>
                                    <td><%# Eval("urun_resim") %></td>
                                    <td>
                                        <%# Eval("urun_aciklama") %>
                                    </td>
                                    <td>
                                        <a href="Edit.aspx?uid=<%#Eval("urun_ID") %>" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Düzenle"><i class="fa fa-pencil font-14"></i></a>
                                        <asp:Button ID="btnDelete" runat="server" Text="SİL"  CommandName="DELETE" class="btn btn-default btn-xs m-r-5"/>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            </asp:DataList>
