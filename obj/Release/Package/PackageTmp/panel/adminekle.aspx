<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminekle.aspx.cs" Inherits="softv1.panel.yetkililer" %>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a class="active" href="adminekle.aspx"><i class="sidebar-item-icon fa fa-user-o"></i>
                ...
                <div class="row">
                    <div class="col">
                        <div class="ibox ibox-primary">
                            <div class="ibox-head">
                                <div class="ibox-title">Yeni Yetkili Bilgileri</div>
                            </div>
                            <div class="ibox-body">
                                
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Yetkili İsim</label>
                                            <asp:TextBox ID="txtAd" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Yetkili Yetki Seviyesi: (Max:10)</label>
                                            <asp:TextBox ID="txtSeviye" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>Yetkili Parola:</label>
                                            <asp:TextBox ID="txtParola" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Yetkili Parola Tekrar:</label>
                                            <asp:TextBox ID="txtParolaTekrar" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Pozisyon: (Muhasebe,İnsan Kaynakları,Saha Şefi vb)</label>
