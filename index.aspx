<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="softv1.index" %>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="display-3 text-white animated slideInLeft">Senin Markan,<br>Senin Seçimin</h1>
                            <p class="text-white animated slideInLeft mb-4 pb-2">1922'den bu yana değişmeyen kalitemizle
                                müşterilerimizin sofralarına lezzet katıyoruz.</p>
                            <a href="/urunler.aspx" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">ÜRÜNLERE GÖZ
                                AT</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="img/hero21.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Üretim ve Tedarik</h5>
                                <p>AOSB Bölgesindeki fabrikamızda üretim gücümüzle, Türkiye'nin tüm illerine dağıtım
                                    yapabilmekteyiz.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Sağlıklı</h5>
                                <p>Ürünlerimiz hijyen koşullarına uygun ve sağlıklı olarak müşteriye ulaştırılmaktadır.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Online Satışlar</h5>
                                <p>Ürünlerimizi Trendyol mağazamızdan online olarak satın alabilirsiniz.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Yerli</h5>
                                <p>Şalgamlarımız coğrafi işaretli olup, tamamen tescilli Adana Şalgamı'dır.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Biz Kimiz?</h1>
                        <p class="mb-4">5 Ocak, 2010 yılında kurulan Suluca Yemekçilik firmasının, yılların deneyimi
                            ile hayata geçirdiği bir lezzet olarak, siz değerli tüketicilerimize sunulmaktadır</p>
                        <p class="mb-4">Suluca Yemekçilik kurucusu Süleyman Kurşun, yemekçilik olarak başladığı
                            meslek hayatına 2021 yılında şalgam üretimini ekleyerek gıda sektöründeki varlığını
                            pekiştirmiştir.</p>
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">13
                                    </h1>
                                    <div class="ps-4">
                                        <p class="mb-0">Yılın</p>
                                        <h6 class="text-uppercase mb-0">Tecrübesiyle</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    ...
                                    <div class="ps-4">
                                        <p class="mb-0">Fazla</p>
                                        <h6 class="text-uppercase mb-0">BAYİLİKLER</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="mb-5">Kullanıcı Yorumları</h1>
                </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="#">Bayi Başvurusu</a>
                    </div>
                </div>
            </div>
    </div>
