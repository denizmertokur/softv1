<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bayiolustur.aspx.cs" Inherits="softv1.panel.bayiekle" %>
                ...
                <ul class="nav navbar-toolbar">
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <span></span>
                            <asp:Label ID="lblUsername2" runat="server" Text="Admin"></asp:Label><i class="fa fa-angle-down m-l-5"></i></a>
                ...
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">
                            <asp:Label ID="lblUsername" runat="server" Text="Admin"></asp:Label></div>
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav-2-level collapse">
                            <li>
                                <a class="active" href="bayiolustur.aspx">Bayi Oluştur</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col">
                        <div class="ibox ibox-primary">
                            <div class="ibox-head">
                                <div class="ibox-title">Yeni Bayi Bilgileri</div>
                            </div>
                            <div class="ibox-body">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <asp:TextBox ID="txtTelefon" runat="server"  CssClass="form-control" TextMode="Number"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Şehir</label>
                                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control">
                                                <asp:ListItem Text="Şehir seçiniz." Value="null" Enabled="false" Selected="True"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label>Adres</label>
                                         <asp:TextBox ID="txtAdres" runat="server"  CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Vergi Numarası:</label>
                                         <asp:TextBox ID="txtVergiNo" runat="server"  CssClass="form-control" TextMode="Number"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <label>Vergi Adresi:</label>
                                         <asp:TextBox ID="txtVergiAdres" runat="server"  CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <label>Fatura Adresi:</label>
                                         <asp:TextBox ID="txtFaturaAdres" runat="server"  CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <asp:Button ID="btnKaydet" runat="server" Text="KAYDET" CssClass="btn btn-success btn-block" OnClick="btnKaydet_Click"/>
                                    </div>
